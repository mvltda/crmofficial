...
<div class="text-center" style="padding:50px 0">
	<div class="logo">Formulario de Ingreso</div>
	<div class="login-form-1">
		<form id="login-form" class="text-left" method="POST">
			...
			<div class="main-login-form">
				<div class="login-group">
					<div class="form-group">
						<label for="inputNickLogin" class="sr-only">Usuario</label>
						<input type="text" class="form-control" id="inputNickLogin" name="inputNickLogin" placeholder="username">
					</div>
					<div class="form-group">
			...
			<div class="etc-login-form">
				<p>¿Perdiste tu contraseña? <a href="/forgot-password.html">Clic Aquí</a></p>
				<p>¿No tienes cuenta? <a href="/register.html"> Solicitar usuario</a></p>
			</div>
		</form>
	</div>
</div>
